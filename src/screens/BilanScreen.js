...
const styles = StyleSheet.create({
  ...
  boutonPrincipal: { backgroundColor: '#1D1D1F', borderRadius: 10, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
  ...
  totalLigne: { borderTopWidth: 1, borderTopColor: '#E5E5EA', paddingTop: 8, marginTop: 4 },
  totalLabel: { fontSize: 13, fontWeight: '600', color: '#1D1D1F' },
  totalValeur: { fontSize: 13, fontWeight: '700', color: '#1D1D1F' },
  carteSituation: { backgroundColor: '#fff', borderRadius: 12, borderWidth: 2, borderColor: '#1D1D1F', padding: 14, marginBottom: 12 },
  ...
  situationNoire: { backgroundColor: '#fff', borderRadius: 10, padding: 12, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
  situationLabel: { color: '#6E6E73', fontSize: 11 },
  situationValeur: { fontSize: 18, fontWeight: '700', marginTop: 2 },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  badgeTexte: { fontSize: 10, fontWeight: '600' },
  clotureBloc: { borderBottomWidth: 1, borderBottomColor: '#F5F5F7', paddingBottom: 10, marginBottom: 10 },
  lienIndigo: { fontSize: 11, color: '#4338CA', fontWeight: '600', marginTop: 4 },
  versementLigne: { backgroundColor: '#F5F5F7', borderRadius: 8, padding: 10, marginTop: 6, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  versementNom: { fontSize: 11, fontWeight: '600', color: '#1D1D1F' },
  ...
  boutonPayer: { backgroundColor: '#1D1D1F', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
