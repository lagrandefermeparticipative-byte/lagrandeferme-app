...
const styles = StyleSheet.create({
  ...
  succesConteneur: { flex: 1, backgroundColor: '#F9FAFB', justifyContent: 'center', alignItems: 'center', padding: 24 },
  succesTitre: { fontSize: 18, fontWeight: '600', color: '#111827', marginBottom: 4 },
  succesTexte: { fontSize: 13, color: '#6B7280', textAlign: 'center', marginBottom: 16 },
  progressLigne: { flexDirection: 'row', gap: 8, marginTop: 8, marginBottom: 16 },
  progressBarreSegment: { flex: 1, height: 4, borderRadius: 2, backgroundColor: '#E5E7EB' },
  progressActive: { backgroundColor: '#111827' },
  ...
  carteSousTexte: { fontSize: 11, color: '#6B7280', marginBottom: 10 },
  ...
  effectifBloc: { backgroundColor: '#F9FAFB', borderRadius: 10, padding: 12, marginBottom: 10 },
  effectifLabel: { fontSize: 11, color: '#6B7280' },
  effectifValeur: { fontSize: 22, fontWeight: '600', color: '#111827' },
  effectifSous: { fontSize: 11, color: '#9CA3AF' },
  ...
  chipMiniTexte: { fontSize: 10, color: '#6B7280' },
  ...
  lienPasser: { textAlign: 'center', color: '#9CA3AF', fontSize: 13, marginTop: 10, marginBottom: 10 },
  ...
  carteNoireMontant: { color: '#fff', fontSize: 22, fontWeight: '600', marginTop: 4 },
  etatLabel: { fontSize: 13, color: '#FB923C', fontWeight: '600' },
  sectionTitre: { fontSize: 13, fontWeight: '600', color: '#111827', marginBottom: 8 },
  scoreBouton: { flex: 1, paddingVertical: 8, borderRadius: 8, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center' },
  ...
  scoreTexte: { fontSize: 12, fontWeight: '600', color: '#6B7280' },
  ...
  checkboxActif: { backgroundColor: '#111827', borderColor: '#111827' },
  checkboxTexte: { fontSize: 12, color: '#374151' },
  videTexte: { color: '#9CA3AF', fontSize: 12, paddingVertical: 8 },
  depenseLigne: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#F9FAFB', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginTop: 4 },
  depenseTexte: { fontSize: 11, color: '#374151' },
  depenseMontant: { fontSize: 11, color: '#6B7280' },
