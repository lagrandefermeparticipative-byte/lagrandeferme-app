        ...
        <View>
          <View style={styles.carte}>
            ...
            <TouchableOpacity style={styles.champ} onPress={() => setAfficherCalendrier('debut')}>
              <Text style={{ fontSize: 13, color: form.date_debut ? '#111827' : '#9CA3AF' }}>{form.date_debut || 'Choisir une date'}</Text>
            </TouchableOpacity>
            <Text style={styles.label}>Date fin prévue</Text>
            <TouchableOpacity style={styles.champ} onPress={() => setAfficherCalendrier('fin')}>
              <Text style={{ fontSize: 13, color: form.date_fin ? '#111827' : '#9CA3AF' }}>{form.date_fin || 'Choisir une date'}</Text>
            </TouchableOpacity>
            {afficherCalendrier && (
              <DateTimePicker
...
const styles = StyleSheet.create({
  conteneur: { flex: 1, padding: 16, backgroundColor: '#F9FAFB' },
  centre: { flex: 1, justifyContent: 'center', padding: 24 },
  titre: { fontSize: 18, fontWeight: '600', color: '#111827', marginBottom: 8, textAlign: 'center' },
  sousTitre: { fontSize: 13, color: '#6B7280', marginBottom: 24, textAlign: 'center' },
  carteChoix: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, padding: 16, marginBottom: 12 },
  carteChoixTitre: { fontSize: 14, fontWeight: '500', color: '#111827' },
  carteChoixSousTitre: { fontSize: 11, color: '#9CA3AF', marginTop: 4 },
  lienAnnuler: { textAlign: 'center', fontSize: 13, color: '#6B7280', marginTop: 16 },
  ...
  segmentActif: { backgroundColor: '#111827' },
  etapeTexte: { fontSize: 11, color: '#9CA3AF', marginBottom: 12 },
  carte: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#F3F4F6', borderRadius: 12, padding: 14, marginBottom: 12 },
  ...
  champ: { borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 13, color: '#111827', backgroundColor: '#fff' },
  ...
  boutonCategorieActif: { backgroundColor: '#111827' },
  boutonCategorieDesactive: { backgroundColor: '#F9FAFB' },
  ...
  pastilleChoixActive: { backgroundColor: '#111827' },
  ...
  bouton3Actif: { backgroundColor: '#111827' },
  bouton3Texte: { fontSize: 11, color: '#4B5563', fontWeight: '500' },
  bouton3TexteActif: { color: '#fff' },
  ligneSwitch: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F9FAFB', borderRadius: 8, padding: 10, marginTop: 10 },
  switchTexte: { fontSize: 11, color: '#4B5563', flex: 1 },
  boutonPrincipal: { backgroundColor: '#111827', borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginBottom: 8 },
  boutonDesactive: { opacity: 0.5 },
  boutonPrincipalTexte: { color: '#fff', fontSize: 13, fontWeight: '600' },
  boutonSecondaire: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginBottom: 20 },
  ...
  pastilleCatActive: { backgroundColor: '#111827' },
