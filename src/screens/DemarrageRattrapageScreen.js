...
const styles = StyleSheet.create({
  ...
  succesTitre: { fontSize: 16, fontWeight: '600', color: '#111827', marginBottom: 8 },
  succesTexte: { fontSize: 13, color: '#6B7280', textAlign: 'center', marginBottom: 20 },
  ...
  progressActif: { backgroundColor: '#111827' },
  ...
  categorieBoutonActif: { backgroundColor: '#111827' },
  categorieBoutonDesactive: { backgroundColor: '#F9FAFB' },
  ...
  infoGrise: { fontSize: 11, color: '#9CA3AF', backgroundColor: '#F9FAFB', padding: 8, borderRadius: 8, marginTop: 8 },
  checkboxLigne: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F9FAFB', borderRadius: 8, padding: 10, marginTop: 10 },
